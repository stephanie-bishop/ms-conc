...
st.sidebar.write(
    "a example file can be found [here](https://github.com/LSARP/ms-conc/tree/main/example_files)"
)
...
st.sidebar.write(
    "an example file can be found [here](https://github.com/LSARP/ms-conc/tree/main/example_files)"
)
