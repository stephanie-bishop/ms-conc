...
from .calibration_curves import (
    calibration_curves,
    calibration_curves_variable_slope,
    calibration_curves_variable_slope_interval,
)
...
def make_curve():
    ...
    curve.at[0, "10000000nm"] /= 20.0
    curve.at[1, "10nm"] *= 20.0
    curve.at[1, "100nm"] /= 5.0
    curve.at[2, "10nm"] *= 5.0
    curve.at[2, "10000000nm"] /= 5.0
    return curve
...
def make_calibration_data_variable_slope_interval():
    curve = make_curve()
    ...
    cc = calibration_curves_variable_slope_interval(X_train, y_train, [0.5, 1.5])
    return X_train, y_train, cc
